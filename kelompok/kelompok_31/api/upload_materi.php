...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        $stmt = $pdo->query("SELECT m.*, mk.nama as nama_mk, mk.kode as kode_mk, u.nama as nama_dosen FROM materi m JOIN mata_kuliah mk ON m.mata_kuliah_id = mk.id JOIN users u ON m.uploaded_by = u.id ORDER BY m.created_at DESC");
