    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div class="mt-8">
                <div class="bg-white card p-6">
                    <h3 class="font-bold text-gray-800 mb-6 text-lg flex items-center">
                        <i class="fas fa-history text-pale-taupe mr-2"></i> Aktivitas Terbaru
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-100">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 w-10 h-10 bg-pale-taupe bg-opacity-20 rounded-full flex items-center justify-center">
                                    <i class="fas fa-user-edit text-pale-taupe"></i>
                                </div>
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-900">Mengelola profil</p>
                                    <p class="text-xs text-gray-500 mt-1">Saat ini</p>
                                    <p class="text-xs text-gray-400 mt-2">Mengedit informasi profil pribadi</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-100">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-xs text-gray-400 mt-2">Laporan penjualan bulanan</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-100">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-xs text-gray-400 mt-2">Menambahkan item menu baru</p>
                                </div>
                            </div>
                        </div>
                    </div>
