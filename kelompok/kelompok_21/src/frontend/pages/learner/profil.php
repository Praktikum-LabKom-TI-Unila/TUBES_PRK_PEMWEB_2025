...
<head>
    ...
    <title>Profil Saya - ScholarBridge</title>
    ...
    <style>
        ...
        .form-section h3 {
            ...
            margin-bottom: 20px;
            padding-bottom: 10px;
            border-bottom: 2px solid #9AD4D6;
        }
...
<nav class="sb-navbar">
    <div class="sb-nav-container">
        <div class="sb-brand">
            <img src="/kelompok/kelompok_21/src/assets/img/logo.png" alt="ScholarBridge Logo" class="logo">
