...
<head>
    ...
    <title>Riwayat Booking - ScholarBridge</title>
                ...
                <div class="booking-card" data-status="<?php echo $booking['status']; ?>">
                    <div class="booking-card-header">
                        <div class="booking-tutor-info">
                            ...
                            <div>
                                <h3 style="margin: 0; color: #0C4A60;"><?php echo htmlspecialchars($booking['tutor_name']); ?></h3>
                    ...
                    <div style="margin-top: 15px; display: flex; gap: 10px;">
                        ...
                        <a href="sesi_saya.php" style="padding: 10px 20px; background: #0C4A60; color: white; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 600;">
                            Booking Lagi
                        </a>
                    </div>
                    <?php endif; ?>
