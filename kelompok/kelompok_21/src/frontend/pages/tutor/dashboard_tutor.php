...
.welcome-section {
    background: linear-gradient(135deg, #0C4A60 0%, #9AD4D6 100%);
    border-radius: 20px;
    padding: 40px;
    color: white;
    margin-bottom: 30px;
    ...
    <div class="sb-nav-container">
        ...
        <div style="display: flex; gap: 10px; align-items: center;">
            <div style="position: relative;">
                <button onclick="toggleDropdown()" class="sb-daftar" style="display: flex; align-items: center; gap: 8px; cursor: pointer; border: none; background: linear-gradient(135deg, #0C4A60, #9AD4D6);">
    ...
    <div class="content-grid">
            ...
            <?php if ($recent_bookings_result && mysqli_num_rows($recent_bookings_result) > 0): ?>
                <?php while ($booking = mysqli_fetch_assoc($recent_bookings_result)): ?>
                    <div class="booking-item">
                        ...
                        <div style="font-weight: 600; color: #0C4A60; margin: 8px 0;">
        ...
        <div>
            ...
            <div class="section-card">
                ...
                <a href="mata_pelajaran.php" style="display: block; text-align: center; margin-top: 15px; color: #0C4A60; font-weight: 600; text-decoration: none;">
