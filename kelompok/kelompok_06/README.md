...
SILATIUM adalah aplikasi web yang menyediakan informasi transportasi umum serta layanan pengaduan masyarakat secara online. Sistem ini dikembangkan menggunakan **PHP Native**, **MySQL**, dan **HTML/CSS/JS** untuk mendukung konsep smart city di bidang transportasi.
...
Sistem dilengkapi autentikasi login, role management (User/Admin), dan tampilan dashboard untuk mempermudah navigasi.
