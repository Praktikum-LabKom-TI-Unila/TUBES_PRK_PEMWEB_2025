...
<body class="bg-gray-100 p-6">
  <h1 class="text-2xl font-bold mb-4">Dashboard Admin — CleanSpot</h1>

  <!-- CARD STATISTIC -->
  <div class="grid grid-cols-3 gap-4 mb-6">
    <div class="p-4 bg-white shadow rounded">
      <div class="text-sm text-gray-500">Total Laporan</div>
      <div class="text-2xl font-semibold mt-2" id="totalReports">—</div>
    </div>
    <div class="p-4 bg-white shadow rounded">
      <div class="text-sm text-gray-500">Laporan Baru</div>
      <div class="text-2xl font-semibold mt-2" id="newReports">—</div>
    </div>
    <div class="p-4 bg-white shadow rounded">
      <div class="text-sm text-gray-500">Laporan Selesai</div>
      <div class="text-2xl font-semibold mt-2" id="doneReports">—</div>
    </div>
  </div>
