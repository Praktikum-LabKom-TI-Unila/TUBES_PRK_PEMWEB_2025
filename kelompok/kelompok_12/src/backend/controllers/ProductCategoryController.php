...
{
    public function __construct(private readonly ProductCategory $categories = new ProductCategory())
    {
    }
    ...
    public function show(Request $request, array $params = []): Response
    {
        ...
        if ($category === null) {
            throw new HttpException('Kategori tidak ditemukan', 404);
        }
    ...
    public function store(Request $request, array $params = []): Response
    {
        ...
        return Response::json(['message' => 'Kategori dibuat', 'data' => $created], 201);
    }
    ...
    public function update(Request $request, array $params = []): Response
    {
        ...
        return Response::json(['message' => 'Kategori diperbarui', 'data' => $updated]);
    }
