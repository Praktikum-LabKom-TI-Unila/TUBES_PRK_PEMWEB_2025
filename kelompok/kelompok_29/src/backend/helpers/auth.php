...
function require_pelapor(): array
{
    ...
    $stmt = $pdo->prepare(
        'SELECT at.user_id, at.expires_at, u.full_name, u.email, u.role, u.phone, u.nik
         FROM auth_tokens at
    ...
    if ($record['role'] !== 'warga') {
        response_error(403, 'Akses hanya untuk pelapor.', [
