            ...
            <div class="animate-fadeIn">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="edit_store.php" class="bg-white border border-gray-200 text-gray-700 px-5 py-3 rounded-xl text-sm font-bold hover:scale-105 hover:shadow-lg transition-all duration-300 flex items-center gap-2">
